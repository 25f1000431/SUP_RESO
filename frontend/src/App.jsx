  ...
  const runSuperResolution =
    async () => {
      ...
      if (!bbox) {
        ...
        setError(
          "Please click on the map to select an area."
        );
    ...
    return (
      ...
      <div className="app">
        ...
        <header className="hero">
          ...
          <p>
            AI-enhanced 10m satellite imagery
            to 2.5m spatial detail
          </p>
        ...
        <main className="container">
          ...
          <section className="result-info">
            ...
            <div className="info-card">
              ...
              <strong>
                {result.sentinel2?.resolution_m || 10}m
              </strong>
            ...
            <div className="info-card">
              ...
              <strong>
                {result.output?.resolution_m || 2.5}m
              </strong>
            ...
            <section className="diagnostic-section">
              ...
              <div className="diagnostic-grid">
                ...
                <div className="diagnostic-card">
                  ...
                  <strong>
                    {
                      diagnostics.input_global?.min?.toFixed(
                        6
                      )
                    }
                  </strong>
                ...
                <div className="diagnostic-card">
                  ...
                  <strong>
                    {
                      diagnostics.input_global?.max?.toFixed(
                        6
                      )
                    }
                  </strong>
                ...
                <div className="diagnostic-card">
                  ...
                  <strong>
                    {
                      diagnostics.input_global?.mean?.toFixed(
                        6
                      )
                    }
                  </strong>
                ...
                <div className="diagnostic-card">
                  ...
                  <strong>
                    {
                      diagnostics.output_global?.min?.toFixed(
                        6
                      )
                    }
                  </strong>
                ...
                <div className="diagnostic-card">
                  ...
                  <strong>
                    {
                      diagnostics.output_global?.max?.toFixed(
                        6
                      )
                    }
                  </strong>
                ...
                <div className="diagnostic-card">
                  ...
                  <strong>
                    {
                      diagnostics.output_global?.mean?.toFixed(
                        6
                      )
                    }
                  </strong>
          ...
          {result.output?.download_url && (
            ...
            <div className="download-section">
              ...
              <a
                ...
                href={
                  `${API_URL}${result.output.download_url}`
                }
    ...
    <div className="app">
      ...
      <header className="hero">
        ...
        <p>
          ...
          Select an area on the map and
          generate AI-enhanced 2.5m
          Sentinel-2 imagery.
      ...
      <main className="container">
          ...
          {bbox && (
            ...
            <div className="bbox-info">
              ...
              <code>
                ...
                {bbox.min_lon.toFixed(
                  5
                )}

                {" , "}

                {bbox.min_lat.toFixed(
                  5
                )}

                {" → "}

                {bbox.max_lon.toFixed(
                  5
                )}

                {" , "}

                {bbox.max_lat.toFixed(
                  5
                )}
        ...
        <section className="step-card">
          ...
          <div className="step-heading">
            ...
            <div>
              ...
              <h2>
                Choose Image Conditions
              </h2>

              <p>
                Select the acquisition period
                and maximum cloud coverage.
              </p>
        ...
        <footer>
          ...
          <p>
            SAT-SR • Sentinel-2 Super Resolution
          </p>

          <p>
            10m input → 2.5m AI-derived output
          </p>
